...
public class MasterMindGUI {
	...
	private void initialize() {
		...
		// make the board and arrays of the components
		...
		// numguesses label
		JLabel numGuesses = new JLabel("Number of possible guesses remaining: " + board.getNumPossibleSolutions());
		...
		guessButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				numGuesses.setText("Number of possible guesses remaining: " + board.getNumPossibleSolutions());
				counter ++;
				}
			}
		});
